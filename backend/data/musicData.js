...
const playlists = [
  ...
  },
  {
    ...
    description: "High-energy tracks to get the party going.",
    mood: "energetic",
    coverImageUrl: "",
    songs: [
      {
  ...
  {
    id: "motivation",
    name: "Motivational Tunes",
    description: "Sweet and romantic songs for special moments.",
    mood: "romantic",
    coverImageUrl: "",
    songs: [
      {
  ...
  },
  {
    ...
    description: "Pump up your workout with these energizing tracks.",
    mood: "intense",
    coverImageUrl: "",
    songs: [
      {
